...
def main():
    ...
    print("   workflow = ConvergenceWorkflow.optimize_parameters(atoms, pseudopotentials, precision='medium')")

    # Method 2: Create workflow with precision, then run manually
    print("\n2. Creating workflow with precision, then running manually:")
    print("   workflow = ConvergenceWorkflow(atoms, pseudopotentials, precision='high')")
    print("   workflow.run_convergence_study()")

    # Method 3: Create from CIF file with precision
    print("\n3. Creating from CIF file with precision:")
