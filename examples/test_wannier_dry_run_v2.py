...
# Write CIF file first
cif_file = '/tmp/Si_test.cif'
si.write(cif_file)

# Define pseudopotentials (using SSSP_1.3.0_PBE_efficiency)
pseudopotentials = {
    'Si': '/home/vinicius/pseudos/SSSP_1.3.0_PBE_efficiency/Si.pbe-n-rrkjus_psl.1.0.0.UPF'
}
