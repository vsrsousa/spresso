...
def main():
    ...
    print("\n=== Precision Levels (Smart Ranges) ===")
    print("Ranges are automatically adjusted based on pseudopotential requirements!")
    print("• 'low': Quick calculations")
    print("  - Low-ecutwfc pseudos: [30, 40, 50] Ry")
    print("  - High-ecutwfc pseudos: [60, 80, 100] Ry")
    print("  - kspacing: [0.5, 0.4, 0.3] Å⁻¹")
    print("• 'medium': Balanced speed/accuracy")
    print("  - Low-ecutwfc pseudos: [40, 50, 60, 70] Ry")
    print("  - High-ecutwfc pseudos: [80, 100, 120, 140] Ry")
    print("  - kspacing: [0.4, 0.3, 0.25, 0.2] Å⁻¹")
    print("• 'high': High accuracy")
    print("  - Low-ecutwfc pseudos: [50, 60, 70, 80, 90] Ry")
    print("  - High-ecutwfc pseudos: [100, 120, 140, 160, 180] Ry")
    print("  - kspacing: [0.3, 0.25, 0.2, 0.15, 0.12] Å⁻¹")
    print("• 'ultra': Maximum accuracy")
    print("  - Low-ecutwfc pseudos: [60, 80, 100, 120, 140] Ry")
    print("  - High-ecutwfc pseudos: [120, 150, 180, 210, 240] Ry")
    print("  - kspacing: [0.25, 0.2, 0.15, 0.12, 0.1] Å⁻¹")
    print("• Ranges are automatically adjusted based on pseudopotential requirements!")
