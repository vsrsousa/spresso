...
def test_kspacing_converted_to_kpts():
    ...
    assert 'kspacing' not in calc.parameters, "kspacing should not be in calculator parameters"
    # kpts should be a tuple of 3 integers
    kpts = calc.parameters['kpts']
    assert isinstance(kpts, tuple) and len(kpts) == 3, "kpts should be a tuple of 3 values"
